<?php 
	...
	$product_query = "SELECT * FROM `lecturer`";
    ...
    <section class="ftco-section bg-light">
			<div class="container-fluid px-4">
				...
				if($product_result){
                  	...
                  	while($lecturer = mysqli_fetch_assoc($product_result)){

					echo "<div class=\"col-md-6 col-lg-3 ftco-animate\">
						<div class=\"staff\">
							<div class=\"img-wrap d-flex align-items-stretch\">
								<img class=\"img align-self-stretch\" src=\"{$lecturer['lecturer_image']}\" alt=\"\">
							</div>
							<div class=\"text pt-3 text-center\">
								<h3>{$lecturer['lecturer_name']}</h3>
								<span class=\"position mb-2\">{$lecturer['lecturer_email']}</span>
								<span class=\"position mb-2\">{$lecturer['course_id_&_name']}</span>
								<div class=\"faded\">
									<p>{$lecturer['lecturer_details']}</p>
