<?php 
	...
	$product_query = "SELECT * FROM `course`";
	    ...
	    <div class="container d-flex align-items-center px-4">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	...
	        	<li class="nav-item"><a href="lecturer.php" class="nav-link">Staff</a></li>
    ...
    <section class="ftco-section">
			<div class="container-fluid px-4">
				...
				if($product_result){
                  	...
                  	while($course = mysqli_fetch_assoc($product_result)){

					echo "<div class=\"col-md-3 course ftco-animate\">
						<img class=\"img\" src=\"{$course['course_image']}\" alt=\"\">
						<div class=\"text pt-4\">
							<p class=\"meta d-flex\">
								<span><i class=\"icon-user mr-2\"></i>{$course['lecturer']}</span>
								<span><i class=\"icon-table mr-2\"></i>{$course['no_of_seats_available']}</span>
